...
- Notifications: UI in `apps/web/app/(app)/notifications/page.tsx`, `apps/web/components/notification-bell.tsx`; API in `apps/api/app/routers/notifications.py`, `apps/api/app/routers/websocket.py`; services in `apps/api/app/services/notification_service.py`
