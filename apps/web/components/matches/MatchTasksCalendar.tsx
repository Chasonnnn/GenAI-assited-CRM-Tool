        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                    <Button variant="outline" size="sm" onClick={() => navigate("prev")} aria-label="Previous time period">
                    ...
                    <Button variant="outline" size="sm" onClick={() => navigate("next")} aria-label="Next time period">
