...
export function ListItem({ interview, isSelected, onClick }: ListItemProps) {
    ...
    return (
        <button
            type="button"
            className={cn(
                "w-full p-4 border-b text-left cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
