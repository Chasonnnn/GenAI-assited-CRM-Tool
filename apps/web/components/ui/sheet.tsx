  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close data-slot="sheet-close" render={<Button variant="ghost" className="absolute top-4 right-4" size="icon-sm" aria-label="Close"><XIcon aria-hidden="true"
            /></Button>} />
        )}
      </SheetPrimitive.Popup>
    </SheetPortal>
