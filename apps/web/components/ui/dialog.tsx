  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <DialogPrimitive.Close data-slot="dialog-close" render={<Button variant="ghost" className="absolute top-4 right-4" size="icon-sm" aria-label="Close"><XIcon aria-hidden="true"
            /></Button>} />
        )}
      </DialogPrimitive.Popup>
    </DialogPortal>
