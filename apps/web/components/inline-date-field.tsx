...
export function InlineDateField({
    ...
    if (!isEditing) {
        return (
            <div
                className={cn(
                    "group flex items-center gap-1 rounded px-1 -mx-1 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1",
