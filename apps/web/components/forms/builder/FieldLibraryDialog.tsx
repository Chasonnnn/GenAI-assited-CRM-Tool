...
export function FieldLibraryDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="h-[min(52rem,calc(100dvh-2rem))] max-h-[calc(100dvh-2rem)] w-[calc(100%-2rem)] grid-rows-[auto_minmax(0,1fr)] gap-0 overflow-hidden p-0 sm:max-w-[980px]">
                <DialogHeader className="shrink-0 border-b border-border/70 px-6 py-4 pr-14">
                    <DialogTitle className="text-xl font-semibold tracking-tight">Add form fields</DialogTitle>
                    <DialogDescription>Search and add fields for the active page.</DialogDescription>
                </DialogHeader>
