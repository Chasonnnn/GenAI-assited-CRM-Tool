"""convert booking links to readable user slugs and merge heads

Revision ID: 20260315_1800
Revises: 20260308_0400, 20260315_1300
...
down_revision: str | Sequence[str] | None = ("20260308_0400", "20260315_1300")
...
def _reassign_booking_slugs(*, per_org: bool) -> None:
    bind = op.get_bind()
    rows = bind.execute(
        sa.text(
            """
...
def upgrade() -> None:
    op.drop_constraint("uq_booking_link_slug", "booking_links", type_="unique")
    _reassign_booking_slugs(per_org=True)
...
def downgrade() -> None:
    ...
    _reassign_booking_slugs(per_org=False)
    op.create_unique_constraint("uq_booking_link_slug", "booking_links", ["public_slug"])
