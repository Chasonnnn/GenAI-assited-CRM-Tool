...
def upgrade() -> None:
    ...
    op.add_column('case_status_history', sa.Column('from_stage_id', postgresql.UUID(as_uuid=True), nullable=True))
    op.add_column('case_status_history', sa.Column('to_stage_id', postgresql.UUID(as_uuid=True), nullable=True))
    op.add_column('case_status_history', sa.Column('from_label_snapshot', sa.String(100), nullable=True))
    op.add_column('case_status_history', sa.Column('to_label_snapshot', sa.String(100), nullable=True))
    op.create_foreign_key('fk_history_from_stage', 'case_status_history', 'pipeline_stages', ['from_stage_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_history_to_stage', 'case_status_history', 'pipeline_stages', ['to_stage_id'], ['id'], ondelete='SET NULL')
    ...
    pipelines = conn.execute(sa.text(
