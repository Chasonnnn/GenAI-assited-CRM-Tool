...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("intended_parent_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("intended_parents.id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_index("ix_zoom_meetings_org_created", "zoom_meetings", ["organization_id", "created_at"])
