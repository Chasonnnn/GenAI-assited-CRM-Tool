...
def upgrade() -> None:
    ...
    # Create unique index for system_key (only for non-null values)
    op.create_index(
        'uq_email_template_system_key',
        'email_templates',
...
def downgrade() -> None:
    ...
    op.drop_index('uq_workflow_system_key', table_name='automation_workflows')
    ...
    op.drop_index('uq_email_template_system_key', table_name='email_templates')
