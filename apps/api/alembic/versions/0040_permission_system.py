...
def upgrade() -> None:
    ...
    op.create_index("idx_role_permissions_org_role", "role_permissions", ["organization_id", "role"])
    ...
    op.create_index("idx_user_overrides_org_user", "user_permission_overrides", ["organization_id", "user_id"])
