...
def upgrade() -> None:
    ...
    op.create_index('idx_audit_org_event_created', 'audit_logs', ['organization_id', 'event_type', 'created_at'])
    op.create_index('idx_audit_org_actor_created', 'audit_logs', ['organization_id', 'actor_user_id', 'created_at'])
