...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "period_type", sa.String(length=10), server_default=sa.text("'minute'"), nullable=False
        ),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "organization_id", "period_start", "route", "method", name="uq_request_metrics_rollup"
        ),
    )
    op.create_table(
        "users",
    ...
    op.create_table(
        ...
        sa.Column(
            "provider", sa.String(length=20), server_default=sa.text("'openai'"), nullable=False
        ),
        sa.Column("api_key_encrypted", sa.Text(), nullable=True),
        sa.Column(
            "model", sa.String(length=50), server_default=sa.text("'gpt-4o-mini'"), nullable=True
        ),
        sa.Column("context_notes_limit", sa.Integer(), server_default=sa.text("5"), nullable=True),
        sa.Column(
            "conversation_history_limit", sa.Integer(), server_default=sa.text("10"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "meeting_mode", sa.String(length=20), server_default=sa.text("'zoom'"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "actions", postgresql.JSONB(astext_type=sa.Text()), server_default="[]", nullable=False
        ),
        ...
        sa.Column(
            "is_system_workflow", sa.Boolean(), server_default=sa.text("FALSE"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "max_file_size_bytes", sa.Integer(), server_default=sa.text("10485760"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("integration_key", sa.String(length=255), nullable=True),
        sa.Column(
            "status", sa.String(length=20), server_default=sa.text("'healthy'"), nullable=False
        ),
        sa.Column(
            "config_status",
            sa.String(length=30),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["converted_case_id"], ["cases.id"], ondelete="SET NULL", use_alter=True
        ),
        sa.ForeignKeyConstraint(["organization_id"], ["organizations.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "organization_id", "role", "permission", name="uq_role_permissions_org_role_perm"
        ),
    )
    op.create_table(
        "system_alerts",
        ...
        sa.Column(
            "severity", sa.String(length=20), server_default=sa.text("'error'"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "case_status_changed", sa.Boolean(), server_default=sa.text("true"), nullable=False
        ),
        ...
        sa.Column(
            "workflow_approvals", sa.Boolean(), server_default=sa.text("true"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "organization_id", "user_id", "permission", name="uq_user_overrides_org_user_perm"
        ),
    )
    op.create_table(
        "user_sessions",
        ...
        sa.Column(
            "ip_address", sa.String(length=45), nullable=True, comment="IPv4 or IPv6 address"
        ),
        sa.Column(
            "user_agent", sa.String(length=500), nullable=True, comment="Raw user agent string"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "source", sa.String(length=20), server_default=sa.text("'manual'"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column(
            "task_type", sa.String(length=50), server_default=sa.text("'other'"), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(["organization_id"], ["organizations.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["workflow_triggered_by_user_id"], ["users.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column("duration_minutes", sa.Integer(), nullable=False),
        sa.Column(
            "buffer_before_minutes", sa.Integer(), server_default=sa.text("0"), nullable=False
        ),
        sa.Column(
            "buffer_after_minutes", sa.Integer(), server_default=sa.text("0"), nullable=False
        ),
        ...
        sa.Column(
            "cancelled_by_client", sa.Boolean(), server_default=sa.text("FALSE"), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["intended_parent_id"], ["intended_parents.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["organization_id"], ["organizations.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "organization_id", "case_id", "intended_parent_id", name="uq_match_org_case_ip"
        ),
    )
    op.create_table(
        "zoom_meetings",
    ...
    op.create_index(
        "idx_tasks_org_created", "tasks", ["organization_id", "created_at"], unique=False
    )
    op.create_index(
        "idx_tasks_org_owner",
        "tasks",
    ...
    op.create_index(
        "idx_tasks_org_status", "tasks", ["organization_id", "is_completed"], unique=False
    )
    op.create_index(
        "idx_tasks_org_updated", "tasks", ["organization_id", "updated_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_exec_entity", "workflow_executions", ["entity_type", "entity_id"], unique=False
    )
    ...
    op.create_index(
        "idx_exec_workflow", "workflow_executions", ["workflow_id", "executed_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_analytics_snapshot_expires", "analytics_snapshots", ["expires_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_appointment_types_org", "appointment_types", ["organization_id"], unique=False
    )
    op.create_index(
        "idx_appointment_types_user", "appointment_types", ["user_id", "is_active"], unique=False
    )
    ...
    op.create_index(
        "idx_availability_overrides_org",
        "availability_overrides",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        "idx_availability_overrides_user", "availability_overrides", ["user_id"], unique=False
    )
    op.create_index(
        "idx_availability_rules_org", "availability_rules", ["organization_id"], unique=False
    )
    ...
    op.create_index(
        "idx_email_suppressions_org", "email_suppressions", ["organization_id"], unique=False
    )
    op.create_index(
        "idx_email_templates_org", "email_templates", ["organization_id", "is_active"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_entity_notes_org", "entity_notes", ["organization_id", "created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_export_jobs_org_created",
        "export_jobs",
        ["organization_id", "created_at"],
        unique=False,
    )
    op.create_index(
        "idx_export_jobs_org_status", "export_jobs", ["organization_id", "status"], unique=False
    )
    ...
    op.create_index(
        "idx_ip_org_created", "intended_parents", ["organization_id", "created_at"], unique=False
    )
    op.create_index(
        "idx_ip_org_owner",
        "intended_parents",
    ...
    op.create_index(
        "idx_ip_org_phone_hash", "intended_parents", ["organization_id", "phone_hash"], unique=False
    )
    op.create_index(
        "idx_ip_org_status", "intended_parents", ["organization_id", "status"], unique=False
    )
    op.create_index(
        "idx_ip_org_updated", "intended_parents", ["organization_id", "updated_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_meta_leads_status", "meta_leads", ["organization_id", "status"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_notif_user_unread", "notifications", ["user_id", "read_at", "created_at"], unique=False
    )
    ...
    op.create_index(
        "idx_queues_org_active", "queues", ["organization_id", "is_active"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_user_sessions_token_hash", "user_sessions", ["session_token_hash"], unique=False
    )
    ...
    op.create_index(
        "ix_ai_usage_log_org_date", "ai_usage_log", ["organization_id", "created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_audit_org_created", "audit_logs", ["organization_id", "created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_campaigns_org_created", "campaigns", ["organization_id", "created_at"], unique=False
    )
    op.create_index(
        "idx_campaigns_org_status", "campaigns", ["organization_id", "status"], unique=False
    )
    ...
    op.create_index(
        "idx_stage_pipeline_active", "pipeline_stages", ["pipeline_id", "is_active"], unique=False
    )
    op.create_index(
        "idx_stage_pipeline_order", "pipeline_stages", ["pipeline_id", "order"], unique=False
    )
    op.create_index("idx_queue_members_user", "queue_members", ["user_id"], unique=False)
    op.create_index(
        "ix_ai_action_approvals_message", "ai_action_approvals", ["message_id"], unique=False
    )
    op.create_index(
        "ix_ai_action_approvals_status", "ai_action_approvals", ["status"], unique=False
    )
    op.create_index(
        "idx_campaign_runs_campaign", "campaign_runs", ["campaign_id", "started_at"], unique=False
    )
    op.create_index(
        "idx_campaign_runs_org", "campaign_runs", ["organization_id", "started_at"], unique=False
    )
    op.create_index(
        "idx_cases_meta_ad",
        "cases",
    ...
    op.create_index(
        "idx_cases_org_created", "cases", ["organization_id", "created_at"], unique=False
    )
    op.create_index(
        "idx_cases_org_owner", "cases", ["organization_id", "owner_type", "owner_id"], unique=False
    )
    op.create_index(
        "idx_cases_org_phone_hash", "cases", ["organization_id", "phone_hash"], unique=False
    )
    op.create_index("idx_cases_org_stage", "cases", ["organization_id", "stage_id"], unique=False)
    op.create_index(
        "idx_cases_org_status_label", "cases", ["organization_id", "status_label"], unique=False
    )
    op.create_index(
        "idx_cases_org_updated", "cases", ["organization_id", "updated_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_cases_search_vector", "cases", ["search_vector"], unique=False, postgresql_using="gin"
    )
    op.create_index(
    ...
    op.create_index(
        "idx_appointments_org_status", "appointments", ["organization_id", "status"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_appointments_org_user", "appointments", ["organization_id", "user_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_appointments_user_date", "appointments", ["user_id", "scheduled_start"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_attachments_intended_parent", "attachments", ["intended_parent_id"], unique=False
    )
    op.create_index(
        "idx_attachments_org_scan", "attachments", ["organization_id", "scan_status"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_campaign_recipients_entity",
        "campaign_recipients",
    ...
    op.create_index(
        "idx_campaign_recipients_tracking_token",
        "campaign_recipients",
        ["tracking_token"],
        unique=True,
    )
    op.create_index(
        "idx_case_activity_case_time", "case_activity_log", ["case_id", "created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_case_interviews_org_conducted",
        "case_interviews",
        ["organization_id", "conducted_at"],
        unique=False,
    )
    op.create_index(
    ...
    op.create_index(
        "idx_profile_hidden_case", "case_profile_hidden_fields", ["case_id"], unique=False
    )
    op.create_index(
        "idx_profile_overrides_case", "case_profile_overrides", ["case_id"], unique=False
    )
    op.create_index(
        "idx_case_history_case", "case_status_history", ["case_id", "changed_at"], unique=False
    )
    op.create_index("idx_email_logs_case", "email_logs", ["case_id", "created_at"], unique=False)
    op.create_index(
        "idx_email_logs_org", "email_logs", ["organization_id", "created_at"], unique=False
    )
    ...
    op.create_index(
        "idx_form_tokens_org", "form_submission_tokens", ["organization_id"], unique=False
    )
    op.create_index(
        "idx_matches_org_created", "matches", ["organization_id", "created_at"], unique=False
    )
    op.create_index(
        "idx_matches_org_status", "matches", ["organization_id", "status"], unique=False
    )
    op.create_index(
        "idx_matches_org_updated", "matches", ["organization_id", "updated_at"], unique=False
    )
    ...
    op.create_index(
        "idx_appointment_email_logs_appt",
        "appointment_email_logs",
        ["appointment_id"],
        unique=False,
    )
    op.create_index(
        "idx_appointment_email_logs_org",
        "appointment_email_logs",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        "idx_tracking_events_recipient", "campaign_tracking_events", ["recipient_id"], unique=False
    )
    op.create_index(
        "idx_tracking_events_type", "campaign_tracking_events", ["event_type"], unique=False
    )
    ...
    op.create_index(
        "idx_form_submissions_org", "form_submissions", ["organization_id"], unique=False
    )
    op.create_index("idx_form_submissions_status", "form_submissions", ["status"], unique=False)
    op.create_index(
        "ix_interview_attachments_interview",
        "interview_attachments",
        ["interview_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_interview_notes_comment_id"), "interview_notes", ["comment_id"], unique=False
    )
    op.create_index(
        "ix_interview_notes_interview", "interview_notes", ["interview_id"], unique=False
    )
    ...
    op.create_index(
        "ix_interview_versions_org",
        "interview_transcript_versions",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        "ix_match_events_match_starts", "match_events", ["match_id", "starts_at"], unique=False
    )
    op.create_index(
        "ix_match_events_org_starts", "match_events", ["organization_id", "starts_at"], unique=False
    )
    ...
    op.create_index(
        "idx_form_files_submission", "form_submission_files", ["submission_id"], unique=False
    )
    ...
    op.create_foreign_key(
        None, "tasks", "workflow_executions", ["workflow_execution_id"], ["id"], ondelete="SET NULL"
    )
    op.create_foreign_key(
        None, "workflow_executions", "tasks", ["paused_task_id"], ["id"], ondelete="SET NULL"
    )
    op.execute("""
