...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('conversation_history_limit', sa.Integer(), nullable=True, server_default='10'),
    ...
    op.create_index('ix_ai_conversations_entity', 'ai_conversations', ['organization_id', 'entity_type', 'entity_id'])
    op.create_index('ix_ai_conversations_user', 'ai_conversations', ['user_id', 'entity_type', 'entity_id'])
    ...
    op.create_table(
        ...
        sa.Column('id', UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
        sa.Column('user_id', UUID(), nullable=False),
        sa.Column('integration_type', sa.String(30), nullable=False),  # gmail, zoom, google_calendar
    ...
    op.add_column('cases', sa.Column('last_contacted_at', sa.DateTime(timezone=True), nullable=True))
