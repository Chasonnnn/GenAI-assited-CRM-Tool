...
def upgrade() -> None:
    ...
    op.create_index("idx_legal_holds_entity_active", "legal_holds", ["organization_id", "entity_type", "entity_id", "released_at"])
    ...
    op.create_index("idx_retention_policy_org_active", "data_retention_policies", ["organization_id", "is_active"])
