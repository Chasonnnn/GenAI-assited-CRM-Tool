...
class AuditEventType(str, Enum):
    ...
    EMAIL_RECONCILIATION_RETRIED = "email_reconciliation_retried"
    EMAIL_RECONCILIATION_LINKED = "email_reconciliation_linked"
    EMAIL_RECONCILIATION_DISMISSED = "email_reconciliation_dismissed"
    EMAIL_RECONCILIATION_CONFIRMED_SENT = "email_reconciliation_confirmed_sent"
    EMAIL_RECONCILIATION_CONFIRMED_NOT_SENT = "email_reconciliation_confirmed_not_sent"
    ...
    FORM_SUBMISSION_MATCHED = "form_submission_matched"
