...
def convert_to_case(
    ...
    try:
        case_data = CaseCreate(
            ...
            height_ft=_parse_decimal(fields.get("height_ft") or fields.get("what_is_your_height_(ft)?")),
            weight_lb=_parse_int(fields.get("weight_lb") or fields.get("what_is_your_weight_(lb)?")),
            is_age_eligible=_parse_bool(fields.get("is_age_eligible") or fields.get("are_you_currently_between_the_ages_of_21_and_36?")),
            is_citizen_or_pr=_parse_bool(fields.get("is_citizen_or_pr") or fields.get("are_you_a_citizen_or_permanent_resident_of_the_us?")),
            has_child=_parse_bool(fields.get("has_child") or fields.get("have_you_given_birth_to_and_raised_at_least_one_child?")),
            is_non_smoker=_parse_bool_inverse(fields.get("do_you_use_nicotine/tobacco_products_of_any_kind_(cigarettes,_cigars,_vape_devices,_hookahs,_marijuana,_etc.)?")),
            has_surrogate_experience=_parse_bool(fields.get("has_surrogate_experience") or fields.get("have_you_been_a_surrogate_before?")),
            num_deliveries=_parse_int(fields.get("num_deliveries") or fields.get("how_many_deliveries_have_you_had?")),
            num_csections=_parse_int(fields.get("num_csections") or fields.get("How many C-sections have you had？")),
