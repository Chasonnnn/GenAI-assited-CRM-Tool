        ...
        if "surrogate" in entity_types:
            ...
            if hash_filters:
                subqueries.append(
                    ...
                    .order_by(literal(2.0).desc(), surrogate_table.c.created_at.desc())
                    .limit(limit + offset)
                )
            ...
            if fallback_filters:
                subqueries.append(
                    ...
                    .order_by(literal(0.5).desc(), surrogate_table.c.created_at.desc())
                    .limit(limit + offset)
                )
        ...
        if "intended_parent" in entity_types and can_view_intended_parents:
            ...
            if hash_filters:
                subqueries.append(
                    ...
                    .order_by(literal(2.0).desc(), ip_table.c.created_at.desc())
                    .limit(limit + offset)
                )
            ...
            if ip_fallback_filters:
                subqueries.append(
                    ...
                    .order_by(literal(0.5).desc(), ip_table.c.created_at.desc())
                    .limit(limit + offset)
                )
