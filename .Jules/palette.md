...
## 2025-05-20 - Global Status Banners Accessibility
**Learning:** Dynamically appearing global status banners (like offline warnings) are not automatically announced by screen readers if they lack appropriate ARIA roles.
**Action:** Always add `role="alert"` to dynamically appearing global warning banners so they are proactively announced to screen reader users.
