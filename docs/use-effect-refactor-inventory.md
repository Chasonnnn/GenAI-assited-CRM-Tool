...
- 54 **REPLACE** Effects removed; 25 **CONTAIN** call sites consolidated behind nine tested synchronization hooks; one baseline **CONTAIN** call site removed after proving it synchronized no external state; 73 production `useEffect` calls remain.
